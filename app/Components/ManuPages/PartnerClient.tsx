...
const partners = [
  { name: 'Restaurant', logo: '/images/p16.jpg' },
  { name: 'Bakery', logo: '/images/p17.jpg' },
  { name: 'Fork & Spoon', logo: '/images/p18.jpg' },
  { name: 'Wolf Coffee', logo: '/images/p19.jpg' },
  { name: 'Bistro', logo: '/images/p20.jpg' },
  { name: 'Bakery', logo: '/images/p21.jpg' },
]
